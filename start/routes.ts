...
Route.put('/edit/:id', 'UsersController.update').as('users.update')
Route.patch('/edit/:id', 'UsersController.patch').as('users.patch')
...
Route.group(() => {
    ...
    Route.put('/:id/update', 'PostsController.update').as('update')
